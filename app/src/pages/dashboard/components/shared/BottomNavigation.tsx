          ...
          {tabs.map((item) => {
            ...
            return (
              <button
                ...
                className={`relative flex flex-col items-center justify-center py-2 px-1 min-w-[50px] transition-all duration-500 ${isActive ? activeColor : 'text-gray-500 hover:text-gray-300'}`}
              >
                {isActive && (
                  <motion.div
