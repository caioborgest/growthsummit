          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div className="flex items-center gap-5">
              <div className="relative group">
                <div className="w-16 h-16 md:w-20 md:h-20 rounded-[1.5rem] bg-gradient-to-br from-yellow-500 to-orange-500 p-0.5 shadow-xl shadow-yellow-500/20 group-hover:scale-105 transition-transform duration-300">
              ...
              <div>
                <h1 className="text-2xl md:text-3xl font-black text-white tracking-tight">
                  {sponsorData?.companyName || 'TechCorp Brasil'}
                </h1>
                <p className="text-yellow-500 font-bold tracking-widest uppercase text-[10px] md:text-xs">Expositor Diamante</p>

                <div className="flex flex-wrap gap-2 mt-3">
                  <Badge className="bg-yellow-500/10 text-yellow-500 border-yellow-500/30 font-bold px-3 py-1">
                    <CheckCircle className="h-3 w-3 mr-1.5" /> Patrocinador Confirmado
                  </Badge>
