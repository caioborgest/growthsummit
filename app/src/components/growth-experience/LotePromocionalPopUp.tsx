    ...
    return (
        <div className={`fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6 bg-black/80 backdrop-blur-md transition-all duration-300 ${isOpen ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}>
            ...
            <Card className={`relative max-w-md w-full max-h-[85vh] overflow-y-auto bg-dark-200 border-brand-orange-coral/40 shadow-[0_0_50px_-12px_rgba(255,112,67,0.3)] transition-all duration-500 transform ${isOpen ? 'scale-100 translate-y-0' : 'scale-95 translate-y-8'} scrollbar-hide`}>
                ...
                <div className="p-5 sm:p-8 pt-0 sm:pt-0 relative z-10">
                    {/* Badge Animada */}
                    ...
                    <div className="text-center mb-8">
                        <div className="relative w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-gradient-to-br from-brand-orange-coral/20 to-brand-orange-intense/10 border border-brand-orange-coral/30 flex items-center justify-center backdrop-blur-sm transform group-hover:scale-105 transition-transform duration-500">
                    ...
                    <h2 className="text-xl sm:text-3xl font-black text-white mb-3 leading-none tracking-tighter uppercase italic">
                        Compre 2<br />
