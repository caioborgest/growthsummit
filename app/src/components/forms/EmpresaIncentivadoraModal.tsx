                    ...
                    {isSuccess ? (
                        <div className="text-center py-12">
                            ...
                            <p className="text-gray-400 text-lg mb-8 leading-relaxed">
                                Sua empresa está oficialmente inscrita para o prêmio **"Melhor Empresa Incentivadora ao Empreendedorismo"**.<br />
                        ...
                        <>
                            <div className="mb-8">
                                ...
                                <h2 className="text-3xl font-bold text-white mb-2">Empresa Incentivadora</h2>
                                <p className="text-gray-400">Inscreva sua equipe e concorra à homenagem oficial no palco principal.</p>
                            </div>
                                ...
                                <div className="grid md:grid-cols-2 gap-4">
                                    <div className="space-y-2">
                                        ...
                                        <div className="relative">
                                            ...
                                            <input
                                                required
                                                className="w-full pl-10 pr-4 py-3 bg-dark-200 border border-white/10 rounded-xl text-white focus:ring-2 focus:ring-brand-orange-coral outline-none"
