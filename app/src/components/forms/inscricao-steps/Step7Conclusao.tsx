        ...
        <div className="text-center space-y-6 animate-in fade-in zoom-in duration-500">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-2xl mx-auto px-4 sm:px-0">
                <div className="p-4 bg-white/5 rounded-2xl border border-white/5 text-center">
                    <Mail className="h-5 w-5 text-brand-orange-coral mx-auto mb-2" />
                    <h5 className="font-bold text-white text-xs uppercase tracking-widest mb-1">Email</h5>
                    <p className="text-[10px] text-gray-500 leading-tight">Confirmação enviada com sucesso</p>
                </div>
                <div className="p-4 bg-white/5 rounded-2xl border border-white/5 text-center">
                    ...
                    <p className="text-[10px] text-gray-500 leading-tight">Sua credencial já está ativa no app</p>
                </div>
                <div className="p-4 bg-white/5 rounded-2xl border border-white/5 text-center">
