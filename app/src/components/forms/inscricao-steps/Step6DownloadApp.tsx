    ...
    return (
        <div className="space-y-6">
            ...
            <div className="text-center">
                ...
                <h3 className="text-xl sm:text-3xl font-black text-white mb-2 leading-tight uppercase italic underline decoration-brand-orange-coral/20">
                    Baixe o Super App
                </h3>
                <p className="text-gray-400 text-sm sm:text-lg max-w-2xl mx-auto px-4 font-medium">
                    Acesse seu crachá, programação e networking em um só lugar.
                </p>
            </div>
            ...
            <div className="flex flex-col items-center gap-4 py-4">
                ...
                <p className="text-[10px] text-gray-500 uppercase tracking-widest font-bold">
                    Instalação Instantânea • Não ocupa espaço
                </p>
            </div>
                ...
                {[
                    {
                        ...
                        desc: 'Seu crachá mesmo sem internet'
                    },
                    {
                        icon: Shield,
                        title: '100% Seguro',
            ...
            <div className="grid md:grid-cols-2 gap-6">
                ...
                <Card className={`p-6 bg-dark-200/50 border-white/10 relative overflow-hidden ${isIOS ? 'ring-2 ring-brand-orange-coral' : ''}`}>
                    {isIOS && (
                        <Badge className="absolute top-2 right-2 bg-brand-orange-coral text-white text-[10px] font-bold">
                            SEU DISPOSITIVO
                        </Badge>
                    )}
                    ...
                    <ol className="list-decimal list-inside space-y-2 text-sm text-gray-300 ml-1 font-bold">
                        ...
                        <li>Confirme em <span className="text-white font-bold">"Adicionar"</span></li>
                    </ol>
                </Card>
                ...
                <Card className={`p-6 bg-dark-200/50 border-white/10 relative overflow-hidden ${isAndroid ? 'ring-2 ring-brand-orange-coral' : ''}`}>
                    ...
                    <ol className="list-decimal list-inside space-y-2 text-sm text-gray-300 ml-1 font-bold">
                        ...
                        <li>Confirme em <span className="text-white font-bold">"Instalar"</span></li>
                    </ol>
                </Card>
            </div>
                ...
                <Card className="p-4 bg-white rounded-xl shadow-lg flex items-center gap-6">
                    ...
                    <div className="text-left">
                        ...
                        <p className="text-xs text-gray-600 max-w-[150px]">
                            Aponte a câmera do celular para instalar o app agora
                        </p>
                    </div>
                </Card>
            </div>
