...
const sessions = [
    // MANHA ANCORA
    { project_id: TRIUNFO_ID, category: 'manha_ancora', start_time: '08:30', end_time: '10:00', title: 'Palestra: Mapa de Crescimento para MPEs', room: 'Salão Principal', type: 'talk' },
    { project_id: TRIUNFO_ID, category: 'manha_ancora', start_time: '10:15', end_time: '11:45', title: 'Palestra + Painel: Digital e WhatsApp', room: 'Salão Principal', type: 'talk' },
    { project_id: TRIUNFO_ID, category: 'manha_ancora', start_time: '11:45', end_time: '12:00', title: 'Encerramento Manhã e Orientações', room: 'Salão Principal', type: 'talk' },

    // TARDE ANCORA
    { project_id: TRIUNFO_ID, category: 'tarde_ancora', start_time: '14:00', end_time: '15:30', title: 'Palestra: Do Improviso ao Plano', room: 'Salão Principal', type: 'talk' },
    { project_id: TRIUNFO_ID, category: 'tarde_ancora', start_time: '15:45', end_time: '17:15', title: 'Talk Show: Histórias de Crescimento', room: 'Salão Principal', type: 'talk' },
    { project_id: TRIUNFO_ID, category: 'tarde_ancora', start_time: '17:15', end_time: '17:30', title: 'Encerramento do Circuito', room: 'Salão Principal', type: 'talk' },
    ...
    // NOTURNA
    { project_id: TRIUNFO_ID, category: 'noturna', start_time: '19:00', end_time: '19:50', title: 'Leandro Batista: Crescimento Exponencial', room: 'Salão Principal', type: 'keynote' },
    { project_id: TRIUNFO_ID, category: 'noturna', start_time: '20:00', end_time: '21:00', title: 'Premiação Arena Pitch + Networking', room: 'Stage', type: 'keynote' },
    { project_id: TRIUNFO_ID, category: 'noturna', start_time: '21:10', end_time: '22:30', title: 'Vanylton Matias: Inovação Corporativa', room: 'Salão Principal', type: 'keynote' },
    { project_id: TRIUNFO_ID, category: 'noturna', start_time: '22:30', end_time: '23:00', title: 'Encerramento Oficial', room: 'Salão Principal', type: 'keynote' },

    // CIRCUITO
    { project_id: TRIUNFO_ID, category: 'circuito', start_time: '08:30', end_time: '17:30', title: 'Espaço Sebrae', description: 'Consultório de Negócios', partner: 'SEBRAE', type: 'circuito', max_capacity: 32, topics: ['MEI', 'Gestão', 'Marketing', 'Vendas', 'Crédito'], metadata: { tempo: '15 min', totalDia: '250 atendimentos' }, color: 'orange' },
    { project_id: TRIUNFO_ID, category: 'circuito', start_time: '08:30', end_time: '17:30', title: 'Espaço Senac', description: 'Carreira e Profissão', partner: 'SENAC', type: 'circuito', max_capacity: 25, topics: ['Carreira', 'Cursos'], metadata: { tempo: '15 min', totalDia: '200 pessoas' }, color: 'orange' },
    { project_id: TRIUNFO_ID, category: 'circuito', start_time: '08:30', end_time: '17:30', title: 'Espaço Sicoob', description: 'Dinheiro e Cooperativismo', partner: 'SICOOB', type: 'circuito', max_capacity: 35, topics: ['Conta PJ', 'Crédito'], metadata: { tempo: '10 min', totalDia: '250 pessoas' }, color: 'orange' },
    { project_id: TRIUNFO_ID, category: 'circuito', start_time: '08:30', end_time: '17:30', title: 'Diagnóstico Digital', description: 'Consultoria Express', partner: 'MKT Dig', type: 'circuito', max_capacity: 18, topics: ['Instagram', 'Google'], metadata: { tempo: '10 min', totalDia: '150 diagnósticos' }, color: 'neutral' },
    { project_id: TRIUNFO_ID, category: 'circuito', start_time: '08:30', end_time: '17:30', title: 'Clínica de Vendas', description: 'Aceleração Comercial', partner: 'Growth', type: 'circuito', max_capacity: 20, topics: ['Scripts', 'Objeções'], metadata: { tempo: '15 min', totalDia: '150 atendimentos' }, color: 'orange' },
    { project_id: TRIUNFO_ID, category: 'circuito', start_time: '08:30', end_time: '17:30', title: 'Balcão de Emprego', description: 'Orientação Profissional', partner: 'Senac + Parceiros', type: 'circuito', max_capacity: 12, topics: ['Currículo', 'Entrevista'], metadata: { tempo: '10 min', totalDia: '100 pessoas' }, color: 'neutral' },
    { project_id: TRIUNFO_ID, category: 'circuito', start_time: '08:30', end_time: '17:30', title: 'Totem Growth', description: 'Espaço Instagramável', partner: 'Growth Experience', type: 'circuito', max_capacity: 50, topics: ['Foto Profissional'], metadata: { tempo: '05 min', totalDia: '400 interactions' }, color: 'orange' },
    { project_id: TRIUNFO_ID, category: 'circuito', start_time: '08:30', end_time: '17:30', title: 'Sabores Locais', description: 'Degustação e Amostras', partner: 'Produtores Locais', type: 'circuito', max_capacity: 80, topics: ['Alimentos', 'Bebidas'], metadata: { tempo: '10 min', totalDia: '1000 degustações' }, color: 'neutral' },
    { project_id: TRIUNFO_ID, category: 'circuito', start_time: '08:30', end_time: '17:30', title: 'IA na Prática', description: 'Tecnologia para PMEs', partner: 'Tech Station', type: 'circuito', max_capacity: 45, topics: ['Criação de Posts', 'IA'], metadata: { tempo: '15 min', totalDia: '300 pessoas' }, color: 'orange' },
    { project_id: TRIUNFO_ID, category: 'circuito', start_time: '08:30', end_time: '17:30', title: 'Arena de Pitches', description: 'Histórias de Negócio', partner: 'Sebrae/Senac', type: 'circuito', max_capacity: 50, topics: ['Pits', 'Cases'], metadata: { tempo: '30 min', totalDia: '400 ouvintes' }, color: 'orange' },
];
