...
INSERT INTO public.projects (name, short_description, slug, type, description, city, state, location, start_date, end_date) 
VALUES 
    ('Growth Experience', 'Growth Experience Juazeiro do Norte', 'growth-experience', 'growth-experience', 'Evento de Growth e Inovação para Empreendedores', 'Juazeiro do Norte', 'CE', 'Boulevard Hotel, Juazeiro do Norte - CE', '2026-04-16', '2026-04-16'),
    ('Growth Experience Triunfo', 'Growth Experience Triunfo-PE', 'growth-experience-triunfo', 'growth-experience', 'Evento de Networking e Negócios em Triunfo-PE', 'Triunfo', 'PE', 'Triunfo - Pernambuco', '2026-04-16', '2026-04-16'),
    ('Growth Experience Petrolina', 'Night Experience Petrolina', 'growth-experience-petrolina', 'growth-experience', 'Evento exclusivo de Networking e Negócios em Petrolina', 'Petrolina', 'PE', 'Petrolina - Pernambuco', '2026-04-30', '2026-04-30')
